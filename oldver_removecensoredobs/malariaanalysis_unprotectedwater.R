...
summary(iptw) #max 50.5
sum(iptw > 5)/length(iptw) #2.53%
sum(iptw > 10)/length(iptw) #0.88%
sum(iptw > 20)/length(iptw) #0.02%
...
summary(iiw) #max 12.37
sum(iiw>5)/length(iiw) #0.07%
...
hist(fiptiw)
summary(fiptiw) #max 64.0
sum(fiptiw > 5)/length(fiptiw) #2.33%
sum(fiptiw > 10)/length(fiptiw) #0.73%
sum(fiptiw > 20)/length(fiptiw) #0.51%
