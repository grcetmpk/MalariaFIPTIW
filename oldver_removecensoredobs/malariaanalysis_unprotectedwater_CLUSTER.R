...
dim(data_children) 
length(unique(data_children$Participant_Id)) #210
...
summary(iptw) #max 34.46
sum(iptw > 5)/length(iptw) #5.75%
sum(iptw > 10)/length(iptw) #1.19%
sum(iptw > 20)/length(iptw) #0.0%
...
summary(iiw) #max 12.82
sum(iiw>5)/length(iiw) #0.12%
sum(iiw>10)/length(iiw) #0.05%
sum(iiw > 20)/length(iiw) #0.00\%
...
hist(fiptiw)
summary(fiptiw) #max 81.26
sum(fiptiw > 5)/length(fiptiw) #3.66%
sum(fiptiw > 10)/length(fiptiw) #1.00%
sum(fiptiw > 20)/length(fiptiw) #0.67
